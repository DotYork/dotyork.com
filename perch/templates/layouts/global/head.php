...
<head>
	...
	<?php 
		if (perch_layout_var('meta', true) == 'speaker') {
			...
			<meta property="og:description" content="The Conference for Curious Minds. Returning for its fifth year on Thursday 4th October 2018." />
			...
			<meta name="twitter:description" content="The Conference for Curious Minds. Returning for its fifth year on Thursday 4th October 2018.">
			<meta name="twitter:image" content="http://dotyork.com/assets/img/social.jpg">
	<?php	} ?>
